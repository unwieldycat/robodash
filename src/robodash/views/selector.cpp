...
rd::Selector::Selector() {
	...
	routine_list = lv_list_create(selector_view.get_obj());
	...
	selected_label = lv_label_create(selector_view.get_obj());
	lv_label_set_text(selected_label, "No routine\nselected");
	...
	lv_obj_t *title = lv_label_create(selector_view.get_obj());
	...
	if (pros::usd::is_installed()) {
		...
		saved_toast = lv_label_create(selector_view.get_obj());
		...
		lv_obj_t *save_btn = lv_btn_create(selector_view.get_obj());
